...
export const updateUserInfo = createAsyncThunk(
  ...
  async (payload: {
    ...
    const { data } = await $authHost.patch("/auth/user", payload);
  ...
  extraReducers: (builder) => {
    builder
      .addCase(toggleTheme.fulfilled, (state, action) => {
        state.theme =
          action.payload === ThemeEnums.light ? lightTheme : darkTheme;
      })
      ...
      .addCase(fetchAuth.fulfilled, (state, action) => {
        ...
        state.theme =
          action.payload.theme === ThemeEnums.light ? lightTheme : darkTheme;
